...
// Dil dosyalarının nerede tutulacağını belirtiyoruz
builder.Services.AddLocalization(options => options.ResourcesPath = "Resources");

// View'lara ve Veri Modellerine dil desteğini entegre ediyoruz
builder.Services.AddControllersWithViews()
    .AddViewLocalization()
    .AddDataAnnotationsLocalization();

// Desteklenen dilleri ve varsayılan dili belirliyoruz
builder.Services.Configure<RequestLocalizationOptions>(options =>
{
    var supportedCultures = new[] { "tr-TR", "en-US" };
    options.SetDefaultCulture("tr-TR") // Varsayılan: Türkçe
